// Kafka Protocol - Transaction Parsers
// Parsing functions for transaction-related requests
module kafka

// parse_init_producer_id_request parses InitProducerId request (API Key 22)
...
// parse_add_partitions_to_txn_request parses AddPartitionsToTxn request (API Key 24)
...
// parse_add_offsets_to_txn_request parses AddOffsetsToTxn request (API Key 25)
...
// parse_end_txn_request parses EndTxn request (API Key 26)
