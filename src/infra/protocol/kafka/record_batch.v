...
// - Magic: i8 (2 for v2)
// - CRC: u32 (CRC32-C of data after CRC field)
// - Attributes: i16
...
// ============================================================================
// CRC32-C Checksum (Castagnoli polynomial)
// ============================================================================

// CRC32-C polynomial table (Castagnoli)
// Pre-computed lookup table for CRC32-C calculation
...
// calculate_crc32c calculates CRC32-C checksum using Castagnoli polynomial
// This is required for Kafka RecordBatch validation
