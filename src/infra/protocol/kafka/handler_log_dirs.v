...
pub fn (mut h Handler) handle_describe_log_dirs(body []u8, version i16) ![]u8 {
	...
	h.logger.debug('Describe log dirs completed', observability.field_int('results',
		resp.results.len), observability.field_duration('latency', elapsed))
