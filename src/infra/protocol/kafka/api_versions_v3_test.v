...
fn test_api_versions_v3_encoding() {
	...
	// SupportedFeatures and FinalizedFeatures were removed from v3 encoding logic
	// because they are likely Tagged Fields or not present in v3 base spec.
	// If they are added back, this test needs to be updated.
