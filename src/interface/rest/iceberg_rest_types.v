// Iceberg REST Catalog API request/response types and conversion functions.
// These types implement the Apache Iceberg REST Catalog API specification.
module rest
...
// Conversion functions (domain -> REST)

/// schema_to_rest converts IcebergSchema to REST API format.
fn schema_to_rest(schema port.IcebergSchema) SchemaRest {
...
fn partition_spec_to_rest(spec port.IcebergPartitionSpec) PartitionSpecRest {
...
fn snapshot_to_rest(snapshot port.IcebergSnapshot) SnapshotRest {
	return SnapshotRest{
...
fn metadata_to_rest(metadata port.IcebergMetadata, location string) TableMetadataRest {
